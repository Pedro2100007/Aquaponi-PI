...
const int pin = 4; //Pino do NodeMCU que estara conectado ao LED
...
void loop() {
  ...
  buf += "<a href='?f=off' class='btn btn-sea'>Ligar Bomba</a> ";
  buf += "</div> ";
  buf += "<div class='col four'> ";
  buf += "<a href='?f=on' class='btn btn-sea'>Desligar Bomba</a> ";
  buf += "</div> ";
  buf += "</div> ";
  buf += "<div class='col twelve'> ";
